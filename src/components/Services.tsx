...
export function Services() {
  return (
    <section id="services" className="py-24 bg-background relative">
      ...
      `}</style>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mb-12 flex justify-center">
        <Link to="/contact" className="px-24 py-4 bg-gradient-to-r from-purple-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-blue-500/50 animate-scale-pulse text-2xl">Apply Now</Link>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card
            id="brokers"
            className="glass-card border-white/10 group hover:border-blue-400/30 transition-all duration-500 hover:scale-105 relative overflow-hidden"
          >
          ...
          <Card
            id="merchants"
            className="glass-card border-white/10 group hover:border-purple-400/30 transition-all duration-500 hover:scale-105 relative overflow-hidden"
          >
          ...
          <Card
            id="underwriting"
            className="glass-card border-white/10 group hover:border-pink-400/30 transition-all duration-500 hover:scale-105 relative overflow-hidden"
          >
